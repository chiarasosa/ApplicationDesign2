...
namespace Obligatorio1.WebApi.Test
{
    ...
    public class UserControllerTest
    {
        ...
        public void RegisterUser_InvalidUser_ReturnsBadRequest()
        {
            ...
            _serviceMock.Setup(s => s.RegisterUser(invalidUser)).Throws(new UserException("Usuario inv�lido"));
            ...
            var users = new List<User>
    {
        ...
        public void GetUserById_ErrorInService_ReturnsBadRequest()
        {
            ...
            // Configura el servicio simulado para lanzar una excepci�n al obtener el usuario por su ID
        ...
        public void Login_ValidCredentials_ReturnsOkResult()
        {
            ...
            // Configura el servicio simulado para devolver el usuario al iniciar sesi�n
        ...
        public void Logout_ErrorInService_ReturnsBadRequest()
        {
            ...
            // Configura el servicio simulado para lanzar una excepci�n al hacer logout
        ...
        public void DeleteUser_NonAdminUser_ReturnsBadRequest()
        {
            ...
            // Act
            var result = _controller.DeleteUser(userToDelete.UserID); // Puedes definir userIdToDelete seg�n tus necesidades
        ...
        public void DeleteUser_UserNotFound_ReturnsNotFound()
        {
            ...
            // Configura el comportamiento mock de _userService para arrojar una excepci�n UserException
        ...
        // Agrega m�s objetos Purchase si es necesario para tus pruebas
    };
        ...
        {
            // Arrange
            var validUser = new User(1, "Usuario1", "Password1", "usuario1@example.com", "Direcci�n1", "Administrador", null);

            // Configura el servicio simulado para devolver el usuario v�lido
            _serviceMock.Setup(s => s.GetLoggedInUser()).Returns(validUser);

            var userToRetrieveHistory = new User(2, "Usuario2", "Password2", "usuario2@example.com", "Direcci�n2", "Rol2", null);
            ...
            var expectedPurchases = new List<Purchase>
    {
        ...
        {
            // Arrange
            var validUser = new User(1, "Usuario1", "Password1", "usuario1@example.com", "Direcci�n1", "Comprador", null);
        ...
        {
            // Arrange
            var userToUpdate = new User(1, "Usuario1", "Password1", "usuario1@example.com", "Direcci�n1", "Administrador", null);
